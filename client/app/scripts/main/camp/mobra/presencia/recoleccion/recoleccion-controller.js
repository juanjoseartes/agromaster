(function () {
  ...
  /* @ngInject */
  function MObraPresencRecController ($scope, $rootScope, $state, $stateParams, $sailsSocket, CurrentFinca, ListEmpleadoModel, HttpService, presRec, $ionicPopover, empleadAv) {
    $scope.presRec = presRec;
    ...
    $scope.getTotal = function(){
      var sumTotal = presRec.reduce(function(memo, resCu) {
  ...
  angular
  .module('App')
  .controller('MObraPresencRecController', MObraPresencRecController);
...
(function () {
  ...
  /* @ngInject */
  function MObraPresencRecEditController ($scope, $rootScope, $state, $stateParams, ListEmpleadoModel, CurrentFinca, HttpService, empleado) {
  ...
  angular
  .module('App')
  .controller('MObraPresencRecEditController', MObraPresencRecEditController);
...
(function () {
  ...
  /* @ngInject */
  function MObraPresencRecChangeController ($scope, $rootScope, $state, $stateParams, CurrentFinca, ListEmpleadoModel, HttpService, empleado) {
  ...
  angular
  .module('App')
  .controller('MObraPresencRecChangeController', MObraPresencRecChangeController);
