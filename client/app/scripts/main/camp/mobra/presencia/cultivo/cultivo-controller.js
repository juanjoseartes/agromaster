(function () {
  ...
  /* @ngInject */
  function MObraPresencCultController ($scope, $rootScope, $state, $stateParams, $sailsSocket, CurrentFinca, HttpService, ListEmpleadoModel, presCult, $ionicPopover, empleadAv) {
    $scope.presCult = presCult;
    ...
    $scope.getTotal = function(){
      var sumTotal = presCult.reduce(function(memo, resCu) {
    ...
    $scope.create = function(empleados) {
      ...
      console.log('Select Empleados: ' + JSON.stringify(model));
      ListEmpleadoModel.create(model).then(function(err) {
        ...
        return ListEmpleadoModel.findToday(model).then(function(modelList) {
          ...
          $state.go('main.camp.mobra.presencia.cultivo', $stateParams);
        });
        //$state.reload();
      });
    };
  ...
  angular
  .module('App')
  .controller('MObraPresencCultController', MObraPresencCultController);
...
(function () {
  ...
  /* @ngInject */
  function MObraPresencCultEditController ($scope, $rootScope, $state, $stateParams, CurrentFinca, ListEmpleadoModel, HttpService, empleado) {
  ...
  angular
  .module('App')
  .controller('MObraPresencCultEditController', MObraPresencCultEditController);
...
(function () {
  ...
  /* @ngInject */
  function MObraPresencCultChangeController ($scope, $rootScope, $state, $stateParams, CurrentFinca, ListEmpleadoModel, HttpService, empleado) {
  ...
  angular
  .module('App')
  .controller('MObraPresencCultChangeController', MObraPresencCultChangeController);
